...
import com.msashkin.eventbus.AbstractRunnableEventConsumer;
...
import com.msashkin.eventbus.EventListener;
...
public final class KafkaEventConsumer<T> extends AbstractRunnableEventConsumer implements EventConsumer<T> {
    ...
    private final Collection<EventListener<T>> listeners = new ArrayList<>();
    ...
    protected Consumer<String, Event<T>> createKafkaConsumer() {
        return new KafkaConsumer<>(properties,
                                   ...
                                   new KafkaEventDeserializer<>(deserializer));
    }
